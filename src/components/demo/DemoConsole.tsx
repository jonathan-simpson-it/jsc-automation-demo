          ...
          <div className="flex items-center gap-4">
            {state.status === 'complete' && (
              <>
                ...
                {workflow.id === 'stamp-ticketing' ? (
                  <a
                    href="/stamp"
                    className="px-4 py-1.5 rounded-full bg-jsc-accent text-white text-[0.65rem] font-mono uppercase tracking-[0.04em] font-medium hover:bg-jsc-muted transition-colors no-underline"
                  >
                    Open live Stamp app
                  </a>
                ) : (
